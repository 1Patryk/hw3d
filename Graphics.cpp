...
{
	// interesting, exisit a quaternion matrix in Dx library
	/*
	...
	*/
	...
	// create vertex buffer (1 2d traingle at center of screen)
	Vertex vertices[] =
	{
		// x  y  z
		{-1.0f, -1.0f, -1.0f},
	...
	// create constatnt buffer for transformation matrix
	...
	const D3D11_INPUT_ELEMENT_DESC ied[] =
	{
		{"Position",
		0,
		DXGI_FORMAT_R32G32B32_FLOAT,		// for 2D -> DXGI_FORMAT_R32G32_FLOAT
		0,
		0,
	...
	GFX_THROW_INFO_ONLY(pContext->DrawIndexed((UINT)std::size(indices), 
		0u,
		0u));
}

// graphics exception stuff
Graphics::HrException::HrException(int line, const  char* file, 
	HRESULT hr, std::vector<std::string> infoMsg) noexcept
	:
	Exception(line, file),
	hr(hr)
{
